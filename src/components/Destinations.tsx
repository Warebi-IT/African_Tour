    ...
    <>
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] flex flex-col items-center justify-center px-6 overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 w-full h-full z-0">
          <img src={destSenegal} alt="" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-espresso/50 z-10"></div>
        </div>

        {/* Hero Content */}
        <div className="relative z-20 text-center max-w-3xl mx-auto">
          <p className="font-dm-sans text-sm uppercase tracking-wider text-[#D9A876] font-bold mb-3 drop-shadow-md">
            PROCHAINES AVENTURES
          </p>
          <h1 className="font-pp-neue-corp-compact text-5xl md:text-7xl font-semibold text-white tracking-tight mb-4 drop-shadow-lg">
            Explorez l'Afrique
          </h1>
          <p className="max-w-xl mx-auto text-lg font-dm-sans font-medium text-white/90 leading-relaxed drop-shadow-md">
            Hébergement, transport, activités et repas inclus selon le programme. Vous profitez du voyage, on s'occupe du reste.
          </p>
        </div>
      </section>
