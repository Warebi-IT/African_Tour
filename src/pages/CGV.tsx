...
const CGV = () => {
 ...
 <div className="prose prose-lg prose-headings:font-pp-neue-corp-compact prose-headings:prose-headings:tracking-tight prose-a:text-citra-orange max-w-none font-dm-sans text-ink/80">
            ...
            <h2>1. Objet</h2>
            <p>
              Les présentes Conditions Générales de Vente (CGV) définissent les modalités de vente des voyages organisés par African Tour à ses clients (ci-après "le Voyageur").
            </p>

            <h2>2. Réservation et Inscription</h2>
            <p>
              La réservation d'un voyage s'effectue via notre site internet. L'inscription n'est définitive qu'à réception de l'acompte (ou du paiement intégral) et après confirmation écrite de notre part.
            </p>
            ...
            <p>
              ...
              <strong>Attention : Nos prix n'incluent jamais les billets d'avion, qui restent à la charge et sous la responsabilité du Voyageur.</strong>
            </p>
            <ul>
            ...
            <h2>4. Annulation par le Voyageur</h2>
            <p>
              En cas d'annulation par le Voyageur, les frais suivants seront retenus :
            </p>
            <ul>
            ...
            <h2>5. Annulation par African Tour</h2>
            <p>
              Si le nombre minimum de participants n'est pas atteint 30 jours avant le départ, African Tour se réserve le droit d'annuler le séjour. Les Voyageurs seront intégralement remboursés des sommes versées pour le séjour, mais ne pourront prétendre à aucune indemnité supplémentaire (notamment concernant les billets d'avion).
            </p>

            <h2>6. Responsabilité</h2>
            <p>
              African Tour agit en tant qu'organisateur du séjour sur place. Nous ne saurions être tenus responsables des modifications de vols, retards, pertes de bagages ou incidents survenant lors du transport aérien, ni des incidents dus à des cas de force majeure (aléas climatiques, politiques, sanitaires).
            </p>
